...
# structure of program: if , elif. While loop 
...
if change > 0: # Als er wisselgeld moet worden gegeven
  ...
  coinCounts = {} # Dictionary om de aantallen van elk munttype op te slaan
  ...
  while change > 0 and coinValue > 0: # Terwijl er nog wisselgeld moet worden gegeven en er nog grotere muntwaarden zijn
    ...
    if nrCoins > 0: # Als er munten van de huidige waarde moeten worden gegeven
      ...
      coinCounts[coinValue] = nrCoinsReturned # Voeg het aantal teruggegeven munten van de huidige waarde toe aan de dictionary
  ...
  print('Overview of returned coins:')
  for coinValue, coinCount in coinCounts.items():
    print(f'{coinCount} coins of {coinValue} cents')
